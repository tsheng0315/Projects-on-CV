# the effect of mask/ sanitary/ social distance
...
class Sim():
    ...
    def arg_within_radius(self,inf,susceptible,r):
        ...
        if(maskBool):
            r=r*maskMod # mask ca reduce the infection radius
    ...
    def data_stream(self):
        while True:
            ...
            if(SDbool):
                jitter=jitter/SDmod # reduce the area each individual can move(social distance)
            self.pos[0:2,:]+=jitter
...
S1 = Sim(init,maskBool=False,saniBool=False,SDbool=False)
